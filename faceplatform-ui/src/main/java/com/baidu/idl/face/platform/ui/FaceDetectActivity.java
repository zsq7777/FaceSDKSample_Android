...
public class FaceDetectActivity extends Activity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnChangeLens).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private Camera open() {
        ...
        while (index < numCameras) {
            ...
            if (cameraInfo.facing == mCurrentCameraId) {
                break;
            }
            index++;
        }
...
//        }
        ...
        Log.i("view的显示宽",mPreviewWidth+"");
        Log.i("view的显示高",mPreviewHight+"");
        // Preview 768,432
